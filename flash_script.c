            ...
            switch(choose)
            {
                case 1:
                    ...
                    if (OS_FLAG == "Windows")
                    {
                        ...
                        system("bin\\fastboot flash tz firmware-update\\tz.img");
                        system("bin\\fastboot flash cmnlib firmware-update\\cmnlib.img");
                        system("bin\\fastboot flash cmnlib64 firmware-update\\cmnlib64.img");
                        system("bin\\fastboot flash devcfg firmware-update\\devcfg.img");
                        ...
                        system("bin\\fastboot flash hyp firmware-update\\hyp.img");
                        system("bin\\fastboot flash keymaster firmware-update\\keymaster.img");
                        system_plus("bin\\fastboot flash LOGO firmware-update\\logo.img");
                        system("bin\\fastboot flash abl firmware-update\\abl.img");
                        system("bin\\fastboot flash mdtp firmware-update\\mdtp.img");
                        system("bin\\fastboot flash mdtpsecapp firmware-update\\mdtpsecapp.img");
                        system("bin\\fastboot flash pmic firmware-update\\pmic.img");
                        system("bin\\fastboot flash xbl firmware-update\\xbl.img");
                        system("bin\\fastboot flash rpm firmware-update\\rpm.img");
                    ...
                    {
                        system_plus("bin/fastboot flash bluetooth firmware-update/bluetooth.img");
                        system("bin/fastboot flash tz firmware-update/tz.img");
                        system("bin/fastboot flash cmnlib firmware-update/cmnlib.img");
                        system("bin/fastboot flash cmnlib64 firmware-update/cmnlib64.img");
                        system("bin/fastboot flash devcfg firmware-update/devcfg.img");
                        system_plus("bin/fastboot flash apdp firmware-update/dpAP.img");
